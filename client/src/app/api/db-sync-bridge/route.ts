...
-- AddForeignKey
ALTER TABLE \"Challenge\" ADD CONSTRAINT \"Challenge_playgroundId_fkey\" FOREIGN KEY (\"playgroundId\") REFERENCES \"Playground\"(\"id\") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE \"LeadMagnetDownload\" ADD CONSTRAINT \"LeadMagnetDownload_leadMagnetId_fkey\" FOREIGN KEY (\"leadMagnetId\") REFERENCES \"LeadMagnet\"(\"id\") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"AIChatConversation\" ADD CONSTRAINT \"AIChatConversation_sessionId_fkey\" FOREIGN KEY (\"sessionId\") REFERENCES \"AIChatConfig\"(\"id\") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"ProjectVideo\" ADD CONSTRAINT \"ProjectVideo_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"LivePreview\" ADD CONSTRAINT \"LivePreview_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE \"CodeSnippet\" ADD CONSTRAINT \"CodeSnippet_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"GeneratedProposal\" ADD CONSTRAINT \"GeneratedProposal_projectType_fkey\" FOREIGN KEY (\"projectType\") REFERENCES \"ProposalTemplate\"(\"id\") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"ClientReport\" ADD CONSTRAINT \"ClientReport_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE \"ThinkingProcess\" ADD CONSTRAINT \"ThinkingProcess_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"Retrospective\" ADD CONSTRAINT \"Retrospective_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"SuccessVideo\" ADD CONSTRAINT \"SuccessVideo_projectId_fkey\" FOREIGN KEY (\"projectId\") REFERENCES \"Project\"(\"id\") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE \"JourneyStep\" ADD CONSTRAINT \"JourneyStep_phaseId_fkey\" FOREIGN KEY (\"phaseId\") REFERENCES \"JourneyPhase\"(\"id\") ON DELETE RESTRICT ON UPDATE CASCADE;
\";
