...
export default function StatsDashboard() {
    ...
    const statItems = [
        { label: "Bugs Fixed", value: stats?.bugsFixed ?? stats?.data?.bugsFixed ?? 0, icon: Bug, color: "text-red-500", bg: "bg-red-500/10" },
        { label: "Case Studies", value: stats?.caseStudiesWritten ?? stats?.data?.caseStudiesWritten ?? 0, icon: BookOpen, color: "text-purple-500", bg: "bg-purple-500/10" },
        { label: "Features Built", value: stats?.featureRequestsCompleted ?? stats?.data?.featureRequestsCompleted ?? 0, icon: CheckSquare, color: "text-green-500", bg: "bg-green-500/10" },
        { label: "Years in Learning", value: stats?.yearsLearning ?? stats?.data?.yearsLearning ?? 0, icon: Calendar, color: "text-yellow-500", bg: "bg-yellow-500/10" },
        { label: "Deployments", value: stats?.deploymentCount ?? stats?.data?.deploymentCount ?? 0, icon: Rocket, color: "text-orange-500", bg: "bg-orange-500/10" },
        { label: "Featured Projects", value: stats?.projectsTotal ?? stats?.data?.projectsTotal ?? 3, icon: Layers, color: "text-blue-500", bg: "bg-blue-500/10" },
    ];
