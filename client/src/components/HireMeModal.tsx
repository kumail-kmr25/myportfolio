                                                ...
                                                <div className="flex gap-4">
                                                    {step === "contact" ? (
                                                        <button
                                                            ...
                                                            className="px-10 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl min-w-[200px] flex items-center justify-center gap-3 text-sm font-black uppercase tracking-widest group shadow-2xl shadow-blue-500/20 transition-all disabled:opacity-50"
                                                        >
