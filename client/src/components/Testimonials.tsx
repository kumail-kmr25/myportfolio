...
function Marquee({ items, reverse = false }: { items: Testimonial[]; reverse?: boolean }) {
    ...
    const duplicated = [...safeItems, ...safeItems, ...safeItems];
                ...
                setTestimonials([
                    {
                        ...
                        message: "Kumail KMR rebuilt our restaurant website from scratch. It loads instantly on mobile now and we're getting way more online orders. Highly professional engineering.",
                        rating: 5,
            ...
            setTestimonials([
                {
                    ...
                    message: "Kumail KMR rebuilt our restaurant website from scratch. It loads instantly on mobile now and we're getting way more online orders.",
                    rating: 5,
                    relationshipType: "Client",
                ...
                },
                {
                    ...
                    role: "Founder",
                    company: "StyleHub",
                    message: "Our PageSpeed went from 28 to 94 after Kumail KMR rebuilt our store. Sales have noticeably improved since the relaunch.",
                    rating: 5,
                    relationshipType: "Client",
