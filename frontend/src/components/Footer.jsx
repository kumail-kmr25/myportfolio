...
const Footer = () => {
    ...
    return (
        <footer className="glass-effect border-t border-white/10 text-white py-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="p-3 bg-white/5 rounded-full hover:bg-primary-500 transition-colors duration-200"
                            >
                            ...
                            <motion.a
                                href="https://www.linkedin.com/in/kumale-ali-bhat"
                                target="_blank"
                                rel="noopener noreferrer"
                                whileHover={{ scale: 1.1, y: -2 }}
                                whileTap={{ scale: 0.9 }}
