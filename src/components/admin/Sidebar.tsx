...
export default function Sidebar({ activeTab, setActiveTab, onLogout, messageCount, pendingFeaturesCount, newHireCount, newLogsCount }: SidebarProps) {
    ...
    return (
        <>
            ...
            {/* Sidebar Container */}
            <aside className={`fixed top-0 left-0 h-full bg-[#080808] border-r border-white/5 z-40 w-72 transition-transform duration-500 ease-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
