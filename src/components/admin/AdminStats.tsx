...
export default function AdminStats({ stats, onUpdate }: { stats: SiteStats | null, onUpdate: () => void }) {
    ...
    return (
        <div className="max-w-4xl space-y-8">
            <div className="bg-white/5 p-8 rounded-[2rem] border border-white/5 flex justify-between items-center">
                <div>
                    <h2 className="text-xl font-bold text-white">System Performance Stats</h2>
                    <p className="text-sm text-gray-500 mt-1">Configure the metrics shown on your public dashboard.</p>
                </div>
                <BarChart3 className="text-blue-500 w-10 h-10 opacity-20" />
            </div>
            ...
            <div className="p-8 rounded-[2rem] bg-blue-500/5 border border-blue-500/10">
                <h4 className="text-blue-400 text-xs font-bold uppercase tracking-widest mb-2">Note on Automation</h4>
