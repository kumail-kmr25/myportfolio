            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    {filteredRequests.length === 0 ? (
                        ...
                        filteredRequests.map((req) => (
                            <div
                                ...
                                className={`p-6 glass-effect rounded-[2rem] border transition-all cursor-pointer group ${selectedRequest?.id === req.id
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-8 space-y-6">
                        {selectedRequest ? (
                            <div className="glass-effect rounded-[2.5rem] border border-white/10 p-8 shadow-2xl">
                                <div className="flex justify-between items-start mb-8">
                                    <div>
                                        <h2 className="text-2xl font-black text-white uppercase tracking-tight">Details</h2>
