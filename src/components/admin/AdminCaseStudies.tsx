    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-center bg-white/5 p-8 rounded-[2rem] border border-white/5">
                <div>
                    <h2 className="text-xl font-bold text-white">Engineering Case Studies</h2>
                    <p className="text-sm text-gray-500 mt-1">Manage problem-solving breakdowns for your portfolio.</p>
                </div>
                <button
