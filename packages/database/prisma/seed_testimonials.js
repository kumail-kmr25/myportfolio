  ...
  const testimonials = [
    {
      ...
      message: 'Kumale delivered our core platform 2 weeks ahead of schedule. The architecture is incredibly clean and easily handles our current scale of 50k daily active users. His attention to security and performance is world-class.',
      rating: 5,
    ...
    },
    {
      ...
      message: 'We brought in Kumale to overhaul our legacy infrastructure. He implemented a robust CI/CD pipeline and optimized our database queries, resulting in a 40% reduction in server costs and a 2.5x speed improvement.',
      rating: 5,
    ...
    },
    {
      ...
      message: 'Working with Kumale has been a game-changer for our product cycle. His ability to bridge the gap between complex backend logic and pixel-perfect UI is rare. Our conversion rate increased by 15% after the latest redesign.',
      rating: 5,
